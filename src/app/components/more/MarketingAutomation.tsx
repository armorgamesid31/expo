...
{ name: 'Oca', sent: 45, opened: 32, converted: 12 },
{ name: 'Şub', sent: 62, opened: 48, converted: 19 },
        ...
        <motion.div
          ...
          <Card className="border-border/50">
            <CardContent className="p-3 text-center">
              ...
              <p className="text-[10px] text-muted-foreground mt-0.5">Kampanya</p>
            </CardContent>
          </Card>
          <Card className="border-border/50">
            <CardContent className="p-3 text-center">
              <p className="text-2xl font-bold text-green-600">%31</p>
              <p className="text-[10px] text-muted-foreground mt-0.5">Dönüşüm</p>
            </CardContent>
          </Card>
          <Card className="border-border/50">
            <CardContent className="p-3 text-center">
              <p className="text-2xl font-bold text-[var(--deep-indigo)]">145</p>
              <p className="text-[10px] text-muted-foreground mt-0.5">Ulaşılan</p>
            </CardContent>
          </Card>
        </motion.div>
          ...
          <Card className="border-green-500/30 bg-green-500/5">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {selectedSegmentData?.count} müşteriye WhatsApp mesajı gönderildi.
                  </p>
                </CardContent>
              </Card> :
          ...
          <Card className="border-[var(--rose-gold)]/20">
                ...
                <CardContent className="space-y-4">
                  ...
                  className="w-full bg-muted/40 rounded-xl px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-[var(--rose-gold)]/30 border border-border transition-all resize-none" />
                    ...
                    <p className="text-[10px] text-muted-foreground mt-1">{"{{name}}"} değişkeni otomatik olarak doldurulur</p>
                  </div>
                ...
                className="w-full py-3 rounded-xl bg-[var(--rose-gold)] text-white text-sm font-semibold disabled:opacity-40 disabled:cursor-not-allowed active:scale-98 transition-all flex items-center justify-center gap-2">
                    ...
                    <Send className="w-4 h-4" />
                    Kampanyayı Gönder
                    {selectedSegmentData && ` (${selectedSegmentData.count} kişi)`}
                  </button>
                </CardContent>
              </Card>
          }
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={160}>
                <BarChart data={campaignPerformance} barSize={10}>
                  ...
                  <Bar dataKey="sent" name="Gönderilen" fill="var(--deep-indigo)" opacity={0.4} radius={[4, 4, 0, 0]} key="bar-sent" />
                  <Bar dataKey="opened" name="Açılan" fill="var(--rose-gold)" opacity={0.7} radius={[4, 4, 0, 0]} key="bar-opened" />
                  <Bar dataKey="converted" name="Dönüşen" fill="#22C55E" radius={[4, 4, 0, 0]} key="bar-converted" />
                </BarChart>
              </ResponsiveContainer>
              <div className="flex items-center gap-4 justify-center mt-2">
                <div className="flex items-center gap-1.5">
                  <div className="w-3 h-3 rounded-sm bg-[var(--deep-indigo)]/40" />
                  <span className="text-[10px] text-muted-foreground">Gönderildi</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <div className="w-3 h-3 rounded-sm bg-[var(--rose-gold)]/70" />
                  <span className="text-[10px] text-muted-foreground">Açıldı</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <div className="w-3 h-3 rounded-sm bg-green-500" />
                  <span className="text-[10px] text-muted-foreground">Dönüştü</span>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                <motion.div
                  ...
                  className="mt-3 pt-3 border-t border-border grid grid-cols-3 gap-3">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-[10px] text-muted-foreground">Açıldı</p>
                      </div>
                      <div className="text-center">
                        <p className="text-lg font-bold text-green-600">{camp.converted}</p>
                        <p className="text-[10px] text-muted-foreground">Dönüştü</p>
                      </div>
                    </motion.div>
                }
                </CardContent>
