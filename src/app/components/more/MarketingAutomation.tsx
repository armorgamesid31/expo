              ...
              <Card className="border-green-500/30 bg-green-500/5">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {selectedSegmentData?.count} müşteriye WhatsApp gönderildi.
                  </p>
                </CardContent>
              </Card>
            ) : (
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={160}>
                <BarChart data={campaignPerformance} barSize={10}>
                  ...
                  />
                  <Bar dataKey="sent" name="Gönderildi" fill="var(--deep-indigo)" opacity={0.4} radius={[4, 4, 0, 0]} key="bar-sent" />
                  <Bar dataKey="opened" name="Açıldı" fill="var(--rose-gold)" opacity={0.7} radius={[4, 4, 0, 0]} key="bar-opened" />
                  <Bar dataKey="converted" name="Dönüştü" fill="#22C55E" radius={[4, 4, 0, 0]} key="bar-converted" />
                </BarChart>
              </ResponsiveContainer>
