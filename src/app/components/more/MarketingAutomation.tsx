    ...
    <div className="h-full pb-20">
      ...
      <div className="sticky top-0 bg-background z-10 border-b border-border p-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Customer campaigns and segments</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 space-y-5">
            ...
            {sentSuccess ? (
              <Card className="border-green-500/30 bg-green-500/5">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-green-700 mb-1">Campaign Sent!</h3>
              ...
              <Card className="border-[var(--rose-gold)]/20">
                ...
                <CardContent className="space-y-4">
                  {/* Segment Selection */}
                  <div>
                    <label className="text-xs text-muted-foreground mb-2 block">Customer Segment</label>
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.1 }}>
          <h2 className="font-semibold mb-3 px-1">Customer Segments</h2>
          <div className="space-y-2">
            {segments.map(seg => (
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.15 }}>
          <h2 className="font-semibold mb-3 px-1">Campaign Performance</h2>
          <Card className="border-border/50">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm flex items-center gap-2">
